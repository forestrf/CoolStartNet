	...
	[
		{
			...
			"objects": [
				{
					"name": "storage",
					"description": "Objects and functions to manage the browser and server database to set and get variables",
					"fast_description": "Objects and functions to manage the browser and server database to set and get variables",
					"objects": [
						{
							"name": "localStorage",
							"description": "functions to set and get data from the browser local storage. This data can be modified by every widget",
							"fast_description": "functions to set and get data from the browser local storage. This data can be modified by every widget",
							"functions": [
								{
									"name": "get",
									...
									"Returns [API.storage.localStorage](#API/objects-storage/objects-localStorage).\n" +
									"\n\n" +
									"```javascript\n"+
